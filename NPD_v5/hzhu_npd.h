...
hzhu_mat hzhu_npd_results(hzhu_mat &detect, hzhu_mat &result_X, hzhu_mat &result_Y)
{
	...
	for (int j = 0; j < counter; j++)
	{
		...
		re.data->data[j * 10 + 3] = result_X.data->data[(max_index + a) * N];//best fitted theta1 for X
		re.data->data[j * 10 + 4] = result_X.data->data[(max_index + a) * N + 1];//best fitted theta2 for X
		re.data->data[j * 10 + 5] = result_X.data->data[(max_index + a) * N + 2];//best fitted theta3 for X
		...
		re.data->data[j * 10 + 7] = result_Y.data->data[(max_index + a) * N];//best fitted theta1 for Y
		re.data->data[j * 10 + 8] = result_Y.data->data[(max_index + a) * N + 1];//best fitted theta2 for Y
		re.data->data[j * 10 + 9] = result_Y.data->data[(max_index + a) * N + 2];//best fitted theta3 for Y
	}
